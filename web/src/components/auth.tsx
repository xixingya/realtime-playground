...
export function AuthDialog({
    ...
    const [baseUrlModel, setBaseUrlModel] = useState(false)
    const [baseUrl, setBaseUrl] = useState(pgState.openaiBaseUrl || "")
    ...
    function onSubmit(values: z.infer<typeof AuthFormSchema>) {
        ...
        dispatch({type: "SET_BASE_URL", payload: baseUrl || null});
        onOpenChange(false);
        onAuthComplete();
    }
    ...
    return (
        <>
            ...
            <Dialog open={baseUrlModel} onOpenChange={setBaseUrlModel}>
                <DialogContent
                    className="sm:max-w-md p-0 border-0 rounded-lg overflow-hidden max-h-[90vh] flex flex-col"
                    isModal={true}
                >
                    <div className="flex gap-2 w-full">
                        ...
                        />
                        <Button onClick={()=>setBaseUrlModel(false)}>OK</Button>
                    </div>
                </DialogContent>
            </Dialog>
        </>
